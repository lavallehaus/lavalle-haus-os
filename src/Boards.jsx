    ...
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(26,26,26,0.35)", zIndex: 300, display: "flex", justifyContent: "flex-end" }}>
      ...
      <div onClick={(e) => e.stopPropagation()} style={{ width: "min(460px, 86vw)", height: "100dvh", background: c.card, borderLeft: `1px solid ${c.line}`, boxShadow: "-14px 0 34px rgba(26,26,26,0.18)", padding: "24px 26px calc(56px + env(safe-area-inset-bottom, 0px))", overflowY: "auto", boxSizing: "border-box", WebkitOverflowScrolling: "touch" }}>
        ...
        <div style={{ display: "flex", gap: 4, flexWrap: "wrap", marginBottom: 8 }}>
          {(opsMode ? [{ n: "Live", c: "#DCE3DC" }, { n: "Pre-Order", c: "#D9CFC1" }, { n: "Ordered", c: "#D9CFC1" }, { n: "In Production", c: "#E9E6DF" }, { n: "Shipped", c: "#C6CCCF" }, { n: "Arrived", c: "#DCE3DC" }, { n: "Shopify", c: "#C6CCCF" }, { n: "Amazon", c: "#E9E6DF" }, { n: "On Hold", c: "#F3E6E3" }, { n: "Priority", c: "#1A1A1A" }] : [
            { n: "Courtney", c: "#FFFFFF" },
