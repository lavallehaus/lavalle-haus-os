// Refillery Haus UGC outreach templates — the DM script + follow-up email used
// on every outreach card. Kept in one place so the copy stays consistent and a
// wording change only happens here. See the "Refillery Haus UGC" board.

export const UGC_DM_SCRIPT =
`Hi, we came across your content and loved your aesthetic. We felt your content aligned beautifully with what we're building at Refillery Haus.
...
export const UGC_EMAIL_SUBJECT = "Refillery Haus — Collaboration Details";

export const UGC_EMAIL_BODY =
`Hi,

Thank you again for connecting with us through Refillery Haus. We're excited to collaborate with you.

Refillery Haus centers around elevated home and body essentials designed to bring a sense of quiet luxury to everyday routines through thoughtful materials, natural ingredients, and timeless design.
...
• Usage: Brand use across Refillery Haus channels
...
Our full creative brief is attached.
...
export const UGC_BRIEF_PDF = "/refillery-haus-ugc-brief.pdf";
